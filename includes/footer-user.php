    <footer id="rodape">
        ...
        <div class="copyright">
            <div class="content">
                Copyright <span style="font-family: Arial, sans-serif;">&copy;</span> <?=$data;?> <a href="<?=URL_DASHBOARD;?>"><?=SITE_NAME;?></a> — A rede social dos otakus!
            </div>
        </div>
        </footer>
        <script src="scripts/jquery-3.1.1.min.js" type="text/javascript"></script>
        <script type="text/javascript" src="./scripts/jquery-1.7.1.min.js"></script>
        <script src="scripts/functions.dashboard.jquery.js" type="text/javascript"></script>
